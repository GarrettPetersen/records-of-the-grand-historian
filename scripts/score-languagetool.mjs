...
const IGNORED_MATCH_TEXT_BY_RULE = {
  ...
  EN_MULTITOKEN_SPELLING_TWO: new Set(['Sima An', 'Chao Cuo', 'Han Zhong', 'Wei Shui', 'Wang Shuo', 'Wang Zhong', 'Lü Chen', 'Tian Fen', 'Xiang Zhuang', 'Xiang Zhong', 'Xun Zhi', 'Yang Zhen', 'Jie Yang', 'Li Gui', 'Bai Yan']),
