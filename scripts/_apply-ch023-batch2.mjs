#!/usr/bin/env node
/** Batch 2: s0101–s0200 (Jiutangshu ch.023, Zhaozong annals) */
...
const T = {
  ...
  s0193: {
    literal: 'In the second year of Dashun, spring, first month, on the day renzi the new moon, Li Keyong pressed the attack on Xing Prefecture.',
  ...
  s0194: {
    ...
    idiomatic: 'Cunxiao called Wang Rong; Rong camped at Yaoshan to rescue him.',
  },
  s0195: {
    literal: 'Keyong came from Taiyuan, defeated him, and advanced to besiege Xing Prefecture.',
    idiomatic: 'Keyong came from Taiyuan, routed Rong, and besieged Xingzhou.',
  },
  s0196: {
  ...
  s0197: {
    literal: 'Vice Director of the Chancellery, Minister of Personnel, and Grand Councillor Liu Chongwang was made Vice Director of the Chancellery, supervised the national history, and judged Revenue affairs; Vice Minister of Works and Grand Councillor Cui Zhaowei judged Revenue affairs.',
    idiomatic: 'Liu Chongwang took Chancellery vice director with history and Revenue; Cui Zhaowei judged Revenue.',
  },
  s0198: {
  ...
  s0199: {
    literal: 'At the time Zhang Jun and Han Jian, after their armies were defeated, were pursued by Taiyuan commanders Li Cunxin and others; only now did they cross from Hanshan over Wang Wo, emerge at Heqing, reach Heyang.',
    idiomatic: 'Jun and Jian, beaten and pursued by Cunxin, crossed Hanshan and Wang Wo to Heyang.',
  },
  s0200: {
    literal: 'The river was in flood and there were no boats; Jian destroyed people\'s houses to make several hundred wooden rafts before they could cross; many were overturned and drowned; they rested their troops at the Minister of Works Temple.',
    idiomatic: 'The river was flooded without boats; Jian tore down houses for hundreds of rafts; many drowned crossing; they rested at the Works Minister\'s temple.',
  },
};
