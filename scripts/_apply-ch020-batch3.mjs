#!/usr/bin/env node
/** Batch 3: s0201–s0300 (Jiutangshu ch.020, Zhaozong annals) */
...
const T = {
  s0201: {
    literal: 'The river overflowed and there were no boats; Jian destroyed people\'s houses and made several hundred wooden jars, and only then crossed; many people capsized and drowned; they rested their troops at the Minister of Works temple.',
    idiomatic: 'The river flooded without boats; Jian built hundreds of wooden floats from wrecked houses; many drowned before they rested at the Works Minister\'s temple.',
  },
  s0202: {
  ...
  s0241: {
    literal: 'In the first year of Jingfu, in the first year of Jingfu, spring, first month, on the day bingwu the new moon, the emperor attended court at Wude Hall to receive congratulations, proclaimed a great amnesty, and changed the era to Jingfu.',
    idiomatic: 'Jingfu 1, spring, first month bingwu new moon: court at Wude Hall, amnesty, era Jingfu.',
  },
  s0242: {
    literal: 'Fengxiang Li Maozhen, Binzhou Wang Xingyu, Huazhou Han Jian, Tongzhou Wang Xingyue, Qinzhou Li Maozhuang, and others submitted memorials denouncing Xingyuan Yang Shouliang for harboring the rebel minister Yang Fugong, asking to campaign together with their own armies, supplying their own grain without Revenue Bureau allotment, only asking to add Maozhen\'s title as southern suppression commissioner.',
    idiomatic: 'Maozhen, Xingyu, Han Jian, and others asked to crush Shouliang for harboring Fugong, supplying their own grain, seeking Maozhen\'s southern suppression title.',
  },
  s0243: {
    literal: 'The inner ministers all rejected their memorial; Zhaozong also believed that once Maozhen held the south of the mountains he would have the ambition to seize the tripod, and the edict was long withheld.',
    idiomatic: 'Eunuchs and Zhaozong refused—Maozhen with the south would aim at the throne—and the edict stalled.',
  },
  s0244: {
    literal: 'Maozhen was enraged and with Wang Xingyu, without awaiting imperial command, sent troops to attack Xingyuan.',
    idiomatic: 'Maozhen and Xingyu attacked Xingyuan without waiting for orders.',
  },
  s0245: {
    literal: 'They repeatedly requested suppression commands and also wrote to chief minister Du Rangneng and army commander Ximen Junsui with abusive words, insulting the royal house; Zhaozong could not bear it in his heart.',
    idiomatic: 'They demanded commands and insulted the court in letters to Du Rangneng and Ximen Junsui.',
  },
  s0246: {
    literal: 'Second month, on the day bingzi the new moon.',
    idiomatic: 'Second month opened on bingzi.',
  },
  s0247: {
    literal: 'On gengyin Taiyuan and Yiding troops combined to attack Zhen Prefecture; Wang Rong again reported distress to Youzhou; Li Kuangwei led thirty thousand foot and horse to hurry there.',
    idiomatic: 'On gengyin Taiyuan and Yiding attacked Zhenzhou; Rong called Kuangwei with thirty thousand.',
  },
  s0248: {
    literal: 'At the time Taiyuan\'s host encamped at Changshan town and Yiding\'s host encamped at Jiangu town; Yan and Zhao troops divided to resist them.',
    idiomatic: 'Taiyuan camped at Changshan, Yiding at Jiangu; Yan and Zhao divided to resist.',
  },
  s0249: {
  ...
  s0259: {
    literal: 'In the second year of Jingfu, in the second year of Jingfu, spring, first month, on the day xinchou the new moon, an edict made Gu Yanhui, acting Dongchuan military commissioner, acting Right Vice Director of the Secretariat, concurrent Zi prefect and Censor-in-Chief, and military commissioner and observer of Jiannan East Circuit.',
    idiomatic: 'Jingfu 2, spring, xinchou new moon: Gu Yanhui was made Dongchuan commissioner.',
  },
  s0260: {
