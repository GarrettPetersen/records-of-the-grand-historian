#!/usr/bin/env node
/** Batch 4: s0301–s0400 (Jiutangshu ch.020, Zhaozong annals) */
...
const T = {
  s0301: {
    literal: 'In the first year of Qianning, in the first year of Qianning, spring, first month, on the day yichou the new moon, the emperor attended court at Wude Hall, proclaimed an amnesty edict, and changed the era to Qianning.',
    idiomatic: 'Qianning 1, spring, first month yichou new moon: court at Wude Hall, amnesty, era Qianning.',
  },
  s0302: {
    literal: 'Fengxiang Li Maozhen came to court, greatly arrayed armed guards, presented thirty singing girls, feasted him in the inner hall, and after several days he returned to his circuit.',
    idiomatic: 'Maozhen came to court with a great guard, gave thirty singers, feasted in the inner hall, then returned.',
  },
  s0303: {
    literal: 'At the time Maozhen held more than fifteen commanderies of Liang, Yang, Xing, Feng, Qi, Long, Qin, Jing, Yuan, and others; his armored troops were mighty and he bullied the weakened royal house, quite having the ambition to seize the tripod.',
    idiomatic: 'Maozhen held fifteen southern commanderies, bullied the court, and eyed the throne.',
  },
  s0304: {
  ...
  s0372: {
    literal: '"',
    idiomatic: 'End of the imperial message.',
  },
  s0373: {
