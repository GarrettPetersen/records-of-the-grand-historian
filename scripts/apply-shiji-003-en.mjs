/**
 * Merges sentence-level English from scripts/shiji-003-translations.json into data/shiji/003.json,
...
const chapterPath = path.join(root, 'data/shiji/003.json');
const mapPath = path.join(root, 'scripts/shiji-003-translations.json');
