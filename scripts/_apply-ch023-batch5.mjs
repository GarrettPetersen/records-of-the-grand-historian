#!/usr/bin/env node
/** Batch 5: s0401–s0500 (Jiutangshu ch.023, Zhaozong annals) */
...
const T = {
  s0401: {
    literal: 'On renyin, Wang Xingyu with his wife, children, and retainers—more than five hundred—broke the encirclement and fled; reaching Qingzhou, Xingyu was killed by his subordinates, and his household of two hundred with them came to the campaign camp to surrender; Li Keyong sent his adjutant Yan E to present them at the capital.',
  ...
  s0463: {
    literal: 'In spring, the first month, on dingchou, the first day of the fourth year, the imperial carriage was at the Huazhou traveling palace and received the hundred officials in audience.',
    idiomatic: 'Fourth year, spring, dingchou new moon: the emperor at Huazhou traveling palace received officials in audience.',
  },
  s0464: {
  ...
  s0488: {
    literal: 'In the fourth month, on bingwu, the first day, Fujian Military Commissioner Wang Chao was further appointed Acting Right Vice Director of the Department of State Affairs.',
    idiomatic: 'Fourth month, bingwu new moon: Fujian commissioner Wang Chao was further made acting right vice director.',
  },
  s0489: {
    literal: 'Han Jian presented ten sealed memorials; the third asked that tutors be appointed to instruct the crown prince and princes.',
    idiomatic: 'Han Jian presented ten sealed memorials; the third asked tutors for crown prince and princes.',
  },
  s0490: {
    literal: 'Crown Prince Mentor Wang Du was then made Lecturer for the Princes.',
    idiomatic: 'Crown Prince Mentor Wang Du was made lecturer for the princes.',
  },
  s0491: {
    literal: 'Grand Councilor Zheng Qi begged retirement on grounds of illness and left government affairs.',
    idiomatic: 'Grand Councilor Zheng Qi begged retirement on illness and left government.',
  },
  s0492: {
    literal: 'In the fifth month, on yihai, the first day, National University Erudite Zhu Pu was made Right Remonstrance Official and Grand Councilor.',
    idiomatic: 'Fifth month, yihai new moon: erudite Zhu Pu became right remonstrance official and grand councilor.',
  },
  s0493: {
    literal: 'On jiaxu, the emperor with academicians and imperial princes ascended Qiyun Tower, gazed west toward Chang\'an, and ordered musicians to sing his composed "Bodhisattva Barbarian" lyrics; when the performance ended all wept soaking their robes; Princes of Tan and below each harmonized.',
    idiomatic: 'On jiaxu the emperor, scholars, and princes climbed Qiyun Tower, gazed at Chang\'an, and had musicians sing his "Bodhisattva Barbarian"; all wept; princes harmonized.',
  },
  s0494: {
    literal: 'In the eighth month, on jiachen, the first day, Minister of Works Lu Yi was made Minister of War.',
    idiomatic: 'Eighth month, jiachen new moon: Lu Yi became minister of war.',
  },
  s0495: {
    literal: 'Han Jian and the three Bin and Qi commands had long shown signs of disloyalty to the ruler; when Li Keyong executed Xingyu, he gnashed his teeth in heart.',
    idiomatic: 'Han Jian and Bin-Qi commands had long shown disloyalty; when Keyong killed Xingyu, he gnashed his teeth.',
  },
  s0496: {
    literal: 'Last year when the carriage was to visit Hedong, he sent Prince of Yan Jiepi as envoy to Taiyuan to see Keyong and explain the plan to tour the realm.',
    idiomatic: 'Last year, bound for Hedong, he sent Prince of Yan Jiepi to Taiyuan to explain touring the realm.',
  },
  s0497: {
    literal: 'That month the Prince of Yan returned from Taiyuan.',
    idiomatic: 'Prince of Yan returned from Taiyuan that month.',
  },
  s0498: {
    literal: 'Han Jian memorialized: "Since Your Majesty\'s accession, strife with near supporters has all been because princes held troops; villains rejoiced in disaster, and the carriage grew unsafe.',
    idiomatic: 'Han Jian wrote: "Since Your accession, strife with near supporters came from princes commanding troops; villains rejoiced and the carriage grew unsafe.',
  },
  s0499: {
    literal: 'Recently I memorialized to end military power, truly fearing unforeseen change.',
    idiomatic: 'I recently asked to end princes\' military power, fearing unforeseen change.',
  },
  s0500: {
    literal: 'Now I hear Princes of Yan and Tan still harbor secret designs; I beg Your Majesty decide without doubt and control disorder before it forms—that is fortune for the altars."',
    idiomatic: 'Now I hear Princes of Yan and Tan still plot; decide without doubt before disorder forms—that is the altars\' fortune."',
  },
};
