#!/usr/bin/env node
/** Apply suishu031 translation batch to current_translation_suishu.json */
...
if (!batchNum || batchNum < 1 || batchNum > 7) {
  console.error('Usage: node scripts/suishu031-apply-batch.mjs <1-7> [translation-file]');
  process.exit(1);
}

const { default: T } = await import(`./suishu031-translations-b${batchNum}.mjs`);
