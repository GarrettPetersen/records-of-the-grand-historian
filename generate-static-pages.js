...
<body data-book="${escapeHtml(bookId)}">
    ...
    <footer>
        <p>
            ...
            Source text from <a href="https://chinesenotes.com" target="_blank" rel="noopener noreferrer">Chinese Notes</a> |
            <a href="https://ctext.org" target="_blank" rel="noopener noreferrer">CText</a> |
...
${contentHTML}
    ...
    <script>
      ...
      function generateCitation(format, type, paragraphIdx, block) {
        ...
        const baseCitation = author + '. "' + chapterTitle + '." In ' + book.name + ' (' + book.chinese + '), translated by Garrett M. Petersen, 2025.';
