...
const patches = {
  'source-yuanshi-088-wikisource-4788b33f6a6a': {
    manualTranslations: [
      mt(
        '尚衣奉御二員，從五品；',
        'two garment-court attendants at rank 5b;',
      ),
    ],
    notes: 'Corrected corrupted 鞶奉御 to 尚衣奉御 to match Wikisource and adjacent 尚衣副奉御.',
  },
  'source-yuanshi-088-wikisource-95624713c6a7': {
    manualTranslations: [
      mt(
        '僉府二員，從三品；',
        'two participant commissioners of the court at rank 3b;',
      ),
    ],
    notes: 'Corrected 參府 to 僉府 per Wikisource 侍正府 office list.',
  },
  'source-yuanshi-088-wikisource-629c51aaef1c': {
    ...
    manualTranslations: [
      mt(
        '肇州等處女直千戶所，達魯花赤一員，千戶一員，副千戶一員，吏目一員，司吏四人。延祐三年置。',
        'The Zhao Prefecture Jurchen Thousand-Households Office: one darughachi, one chiliarch, one deputy chiliarch, one clerical officer, and four bureau clerks. Established in Yanyou year 3.',
      ),
      mt(
        '朵因溫都兒兀良哈千戶所，延祐三年置。',
  ...
  'source-yuanshi-088-wikisource-c21b336405cf': {
    ...
    manualTranslations: [
      ...
      mt('至大元年置。領提舉司三，庫、局各一。', 'Established in Zhida year 1. It oversaw three directorates, one storehouse, and one bureau.'),
      mt(
        '平江、松江、建康等處提舉司凡三處，秩並正五品。每司各設達魯花赤一員、提舉一員、同提舉一員、副提舉一員、都目一員、吏目一員、司吏六人。',
        'Three directorates at Pingjiang, Songjiang, and Jiankang, all at rank 5a; each had one darughachi, one director, one associate director, one deputy director, one chief clerk, one clerical officer, and six bureau clerks.',
      ),
    ],
    notes:
...
console.log('Applied', ids.length, 'source-correspondence items for yuanshi/088');
